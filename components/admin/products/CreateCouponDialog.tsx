...
const CreateCouponDialog = ({ isModal, setIsModal }: any) => {
  return (
    <Dialog
      as="div"
      ...
      <div className="fixed inset-0 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4">
          <Dialog.Panel className="w-[623px] h-full  transform overflow-hidden  bg-white p-8  shadow-xl transition-all">
            ...
            <div className="mt-4">
              <div className="text-dark-0">Code</div>
              <input
                type="text"
                className="border border-border-light outline-none px-4 py-2 w-full"
              />
            ...
            <div className="mt-4">
              <div className="text-dark-0">Products</div>
              <input
                type="text"
                className="border border-border-light outline-none px-4 py-2 w-full"
              />
            ...
            <div className="mt-4">
              <div className="text-dark-0">Discount Percentage</div>
              <input
                type="text"
                className="border border-border-light outline-none px-4 py-2 w-full"
              />
