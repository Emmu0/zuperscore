...
const MathRefIcon = ({ width = "30px", height = "100%", className, fill = "none" }: Props) => {
  return (
    <svg
      version="1.1"
      id="Capa_1"
    ...
    >
      <g>
        <path
          d="M15.383,18.945l7.761,12.506h-5.398l-3.48-5.825c-0.533-0.9-1.041-1.812-1.527-2.736l-0.498-0.959l-0.515-0.941h-0.07
