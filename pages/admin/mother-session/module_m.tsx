        ...
        <AdminLayout padding={false}>
          <div className="py-5">
            <div className="container mx-auto px-5 flex justify-between items-center">
              <div className="text-2xl font-medium pb-1">Module</div>

              <div className="flex gap-2">
                <Button
                  size="sm"
                  className="flex items-center gap-2"
                  onClick={() => popupHandler("module_mother")}
                >
                  <PlusIcon width="14" height="14" fill="#F3E4B1" /> Create Module
                </Button>
              </div>
            </div>

            <div className="mt-5">  <MotherSessionTable type="module_mother" /></div>
          </div>
        </AdminLayout>
      </Container>
