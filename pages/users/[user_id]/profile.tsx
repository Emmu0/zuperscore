              ...
              <div className="space-y-4">
                    ...
                    <div className="flex">
                      <div className="mr-4 relative h-full w-32">
                        <div className="w-full h-full">
                          <Image
                            src={
                              userDetail.profile_img ? userDetail.profile_img : "/default_image.png"
                            }
                ...
                <div className="border border-gray-200 bg-white rounded-sm shadow-sm p-3 px-4 space-y-6">
                  <ProfileForm
                    ...
                    disabled={user?.role == "tutor" && user.id != user_id}
                  />
                  {!displayPage ? (
                    <Button
                      size="sm"
                      onClick={handleSubmit(onSubmit)}
                      disabled={isSubmitting || (user?.role == "tutor" && user.id != user_id)}
                    >
